...
6. "Guias de adoção para React + Angular + casos de estudo funcionais em github.com/pkuschnirof/rpaforce-crm. Spec em yujin.app/nac-spec/SPEC.md."
...
- Stars + forks no GitHub em `pkuschnirof/rpaforce-crm` e
  `pkuschnirof/yujin`.
